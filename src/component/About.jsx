...
import './About.css';
import './Skills.css'; // Import the Skills CSS styles
...
const About = () => {
    ...
    const aboutData = {
        ...
        linkedIn: 'https://www.linkedin.com/Amde-Haimanot/',
    ...
    return (
        <div className="about-container">
            <div className="left-parts">
                <img className="about-image" src={require('../port-images/cassop.jpg')} alt="cassopia" />
            </div>
            <div className="right-parts">
                ...
                <div className="description">
                    Welcome to my portfolio! I’m Amde Haimanot, a passionate Frontend Developer with a strong focus on creating dynamic and user-friendly web applications. With a background in Information Systems from Wokite University and a keen eye for web development, I specialize in transforming ideas into beautifully functional experiences.
                </div>
    ...
    <div className="info-descriptions">
        ...
        <p><a href={aboutData.gitHub} target="_blank" rel="noopener noreferrer">Amde-88</a></p>
                ...
                <button className="cv-button" onClick={handleDownloadCV}>Download CV</button>
            </div>
...
const Skills = () => {
    ...
    return (
        <div className="skills-container">
            <h2>Skills</h2>
            <h3>I possess a comprehensive set of skills relevant to my role as a Frontend Developer,
                 covering all essential areas of expertise.</h3>
            <p>As a Frontend Developer, I specialize in Javascript to create dynamic, interactive web applications.
                 My experience with MongoDB allows for efficient data management and storage.
                  I leverage React for building user interfaces and utilize Git and GitHub for effective 
                  version control and collaboration. Additionally, I focus on API integration and responsive design to
                   ensure seamless user experiences across devices,
                 though my primary focus is on web development rather than mobile apps.</p>
            <div className="skills-list">
                {skillsData.map((skill, index) => (
                    <div className="skill-item" key={index}>
                        <div className="skill-name">{skill.name}
